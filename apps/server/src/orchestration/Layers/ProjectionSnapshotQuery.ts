...
const ThreadShellLookupInput = Schema.Struct({
  threadId: ThreadId,
...
const makeProjectionSnapshotQuery = Effect.gen(function* () {
  ...
  const getThreadRowById = SqlSchema.findOneOption({
    Request: ThreadShellLookupInput,
    Result: ProjectionThreadDbRowSchema,
          ...
          ([
            ...
            Effect.gen(function* () {
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                ...(row.linkedIssue === null ? {} : { linkedIssue: row.linkedIssue }),
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (
    ...
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        ...(threadRow.value.linkedIssue === null
          ? {}
          : { linkedIssue: threadRow.value.linkedIssue }),
