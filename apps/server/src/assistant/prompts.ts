...
The person may answer any open decision, including a thread's question, by writing to you here. Pass it on with assistant_answer_decision and the decision id; the asking thread continues with it. Relay only what they told you.
