...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.assistantAddProjectNote]: AuthOrchestrationOperateScope,
  [WS_METHODS.assistantDeleteProjectNote]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.serverGetProjectHistory]: AuthOrchestrationReadScope,
  [WS_METHODS.serverRefreshUsageRates]: AuthOrchestrationReadScope,
  [WS_METHODS.serverSignalProcess]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverStopAgentProcess]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.googleCalendarStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.googleCalendarAuthorize]: AuthAccessWriteScope,
  [WS_METHODS.googleCalendarDisconnect]: AuthAccessWriteScope,
  [WS_METHODS.googleCalendarCalendars]: AuthOrchestrationReadScope,
  [WS_METHODS.googleCalendarEvents]: AuthOrchestrationReadScope,
  [WS_METHODS.googleCalendarSchedule]: AuthOrchestrationOperateScope,
  [WS_METHODS.googleCalendarUpdate]: AuthOrchestrationOperateScope,
  [WS_METHODS.linearDelegationStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.linearDelegationAuthorize]: AuthAccessWriteScope,
  [WS_METHODS.linearDelegationDisconnect]: AuthAccessWriteScope,
  [WS_METHODS.linearDelegationStop]: AuthOrchestrationOperateScope,
  [WS_METHODS.linearStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.linearWorkspace]: AuthOrchestrationReadScope,
  [WS_METHODS.linearListIssues]: AuthOrchestrationReadScope,
  [WS_METHODS.linearGetIssue]: AuthOrchestrationReadScope,
  [WS_METHODS.linearPrepareIssueThread]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.subscribeAgentProcesses]: AuthOrchestrationReadScope,
